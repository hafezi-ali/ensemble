...
\sethlcolor{tier3bg}
\soulregister{\cite}{1}   % let soul step over \cite inside \hl
% \tchange{changed/added text}{short comment}
\newcommand{\tchange}[2]{\hl{#1}\,\textcolor{tier3note}{\footnotesize[\textbf{T3:} #2]}}
% \hlonly{text} — amber highlight with no inline tag (continued added spans)
\newcommand{\hlonly}[1]{\hl{#1}}
% \tnote{comment} — standalone note for structural additions with no highlightable text
