...
st = pd.read_csv(ROOT + "data/noclustering_stats.csv")
ours = "DDEL-GMM (ours)"
...
fig.tight_layout()
fig.savefig(ROOT + "manuscript/noclustering_comparison.pdf", bbox_inches="tight")
fig.savefig(ROOT + "noclustering_comparison_preview.png", dpi=150, bbox_inches="tight")
print(f"CD={CD:.3f}")
