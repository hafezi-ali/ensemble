...
BEST = os.path.join(ROOT, "code", "best_ensemble_results.csv")
SEL = os.path.join(ROOT, "data", "selection_rule_diagnostic.csv")
...
fig1.savefig("fig1_pipeline.png", dpi=200, bbox_inches="tight", pad_inches=0.02)
...
fig2.savefig("fig2_diagnostics.png", dpi=200, bbox_inches="tight", pad_inches=0.02)
